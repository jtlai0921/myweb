...
public class studentDao implements implDao {
	...
	public static void main(String[] args) {
		 ...
		 * 
		 * Query q=se.createQuery(HQL); q.setParameter(1, 8); q.setParameter(2, 13);
		 * q.setParameter(3, "tttt");
		 */
		/*
		 * String SQL="select * from student"; SQLQuery q=se.createSQLQuery(SQL);
		 * q.addEntity(student.class);
		 * 
		 * List<Object> l=q.list();
		 * 
		 * for(Object o:l) { student s=(student)o;
		 * System.out.println("id:"+s.getId()+"\tname:"+s.getName()); }
		 */
